...
// URL halaman aktivasi (login/register/perpanjangan)
// ⚠️ Sesuaikan lagi kalau struktur folder hosting Anda berbeda dari
//    "https://domain-anda/aktivasi/index.html".
...
const targetOlahragaData = {
  ...
  hybrid_agresif: [
    { hari: 'Sen', aktivitas: 'Lompat tali 15 menit + Jalan kaki 30 menit + Lymphatic 10 menit' },
    { hari: 'Sel', aktivitas: '🏋️ Gerak Aktif 25 menit: Squat Jump 3×15 + Push Up 3×15 + Plank 3×40 dtk + Burpee 3×8', isResistance: true },
    { hari: 'Rab', aktivitas: 'Jalan kaki 45 menit + Jumping Jack 5 set + Lymphatic 10 menit' },
    ...
    { hari: 'Sab', aktivitas: 'Jalan kaki 60 menit + Lompat tali 10 menit + Lymphatic 10 menit' },
    { hari: 'Min', aktivitas: 'Jalan santai 30 menit (Active Recovery) + Lymphatic sebelum tidur' }
  ],

  // ── Mode No Exercise: NEAT + Bodyweight Minimal ───────────
  // Untuk yang tidak mau olahraga — framing sangat ringan
  neat: [
    { hari: 'Sen', aktivitas: 'NEAT: Jalan kaki 20 menit + Naik tangga + Lymphatic 10 menit' },
    { hari: 'Sel', aktivitas: '⚡ Bodyweight 10 menit: Squat 2×10 + Push Up Lutut 2×8 + Plank 2×15 dtk + Lymphatic 10 menit', isResistance: true },
    { hari: 'Rab', aktivitas: 'NEAT: Berdiri & jalan di tempat 5 menit tiap 1 jam + Lymphatic 10 menit' },
    { hari: 'Kam', aktivitas: 'NEAT: Jalan kaki 20 menit setelah makan malam + Lymphatic sebelum tidur' },
    { hari: 'Jum', aktivitas: '⚡ Bodyweight 10 menit: Glute Bridge 2×12 + Wall Sit 2×20 dtk + Calf Raise 2×15 + Lymphatic 10 menit', isResistance: true },
    { hari: 'Sab', aktivitas: 'NEAT: Aktivitas rumah aktif (bersih-bersih, berkebun) + Lymphatic 15 menit' },
